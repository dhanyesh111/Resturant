...
static List<GetPage> appPages = <GetPage>[
  ...
  GetPage(name: AppRoutes.billing,
  ...
  GetPage(name: AppRoutes.managePaymentMethods,
  ...
  GetPage(name: AppRoutes.trackOrder,
   page: () => const TrackOrderScreen(),
   binding: TrackOrderControllerBinding()),
   
  GetPage(name: AppRoutes.typeSelection,
